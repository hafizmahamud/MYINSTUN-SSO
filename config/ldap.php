    ...
    */
    ...
    'connections' => [
        ...
        'default' => [
            ...
            'username' => env('LDAP_USERNAME', 'cn=directory manager'),
            'password' => env('LDAP_PASSWORD', '4a/4LwnGqexw'),
            'port' => env('LDAP_PORT', 5901),
            'base_dn' => env('LDAP_BASE_DN', 'ou=people,o=gluu'),
