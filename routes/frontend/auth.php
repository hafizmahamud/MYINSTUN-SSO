...
use App\Http\Controllers\Frontend\Auth\ActivateController;
use App\Http\Controllers\Frontend\Auth\ActivateUserController;
...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
   ...
   // Route::get('password/reset', [ForgotPasswordController::class, 'showLinkRequestForm'])->name('password.email');
    ...
    Route::get('activate/username', [ActivateUserController::class, 'ActivateRequestForm'])->name('activate.username');
    Route::post('activate/email', [ActivateUserController::class, 'sendResetLinkEmail'])->name('activate.email.post');
    
    Route::get('activate/user/{token}', [ActivateController::class, 'showActivateForm'])->name('activate.user.form');
    Route::post('activate/user', [ActivateController::class, 'activate'])->name('activate.user');
});
