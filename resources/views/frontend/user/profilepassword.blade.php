						...
						<main class="col-lg-12">
							<article>
								<header class="entry-header">
									<h4 style="padding-bottom: 10px">Kemaskini Kata Laluan
									</h4>
								</header>
								<!-- .entry-header -->
								<div class="entry-content">
									<div class="woocommerce">
										...
										<div class="woocommerce-MyAccount-content">
                                            ...
                                            <form class="woocommerce-EditAccountForm edit-account" action="{{ route('frontend.user.profilepassword.update')}}" method="post">
                                                @csrf <!-- {{ csrf_field() }} -->

                                                <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
													<label for="account_first_name">New Password <span id="req" class="required">*</span>
													</label>
													<input type="password" autocomplete="off" class="woocommerce-Input woocommerce-Input--text input-text" name="password" id="password" oninput="verify()" placeholder="Password" required>
													<i class="far fa-eye" id="togglePassword" onclick="hide()" style="margin-left: -30px; margin-top: 15px; cursor: pointer;"></i>
												</p>
                                                <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
													<label for="account_first_name">Password Confirmation <span id="req2" class="required">*</span>
													</label>
													<input type="password" autocomplete="off" class="woocommerce-Input woocommerce-Input--text input-text" name="password_confirmation" id="password_confirmation" oninput="confirmPassword()" placeholder="Password Confirmation" required>
													<i class="far fa-eye" id="togglePassword2" onclick="hide2()" style="margin-left: -30px; margin-top: 15px; cursor: pointer;"></i>
												</p>
												<div class="clear"></div>
												<p>
													<input type="submit" class="woocommerce-Button button" name="save_account_details" value="Change Password">
												</p>
											</form>
