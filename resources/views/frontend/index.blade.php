					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-xl-2 col-lg-4 col-md-5 col-11">
								<a href="./" class="logo">
									<img src="/img/SSO_instun_latest.png" alt="">
								</a>
								
							</div>
							<div class="col-4 d-xl-block">
										<div id="buttonNav" class="widget course-dropdown">
										    <a href="" style="padding-right:1%;"><i class="fs-16 fa fa-user" aria-hidden="true"></i> PROFILE</a>
											<a class="dropdown-toggle" href="{{route('frontend.auth.login')}}">@lang('navs.frontend.login')</a>
									  	</div>	
							</div>
						</div>
					</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-md-5">
							<div  class="intro_layers_wrapper icon-layer">
								...
								<a href="https://espek.plisca.net/user/connect" class="icon-box text-center bordered rounded animate" data-animation="moveFromLeft">
									...
									<a href="{{route('frontend.error')}}" class="icon-box text-center bordered rounded animate" data-animation="moveFromLeft">
										<div class="color-main icon-styled fs-32" style="padding-top:10%;">
									...
									<a href="https://etouch.plisca.net/oauth2_login.php" class="icon-box text-center bordered rounded animate" data-animation="moveFromLeft">
										<div class="color-main icon-styled fs-32" style="padding-top:10%;">
											<i class="icon-eTouch" aria-hidden="true"></i>
										</div>
										<p>
									...
									<a href="https://esecure.plisca.net/auth/espek/callback" class="icon-box text-center bordered rounded animate" data-animation="moveFromLeft">
										<div class="color-main icon-styled fs-32" style="padding-top:10%;">
								...
								<a href="{{route('frontend.error')}}" class="icon-box text-center bordered rounded animate" data-animation="moveFromLeft">
									...
									<a href="https://muzium.instun.gov.my" class="icon-box text-center bordered rounded animate" data-animation="moveFromLeft">
								...
								<div id="boxApplication" class="intro_layers">
									<a href="https://sso.instun.gov.my/idp/profile/cas/login?service=https://library.plisca.net/cgi-bin/koha/opac-user.pl" class="icon-box text-center bordered rounded animate" data-animation="moveFromLeft">
										<div class="color-main icon-styled fs-32" style="padding-top:10%;">
