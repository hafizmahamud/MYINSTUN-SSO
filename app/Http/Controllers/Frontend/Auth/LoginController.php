...
class LoginController extends Controller
{
	...
	if ($token != '' || $token != null) {
	   Cookie::queue(Cookie::forget('id_token_hint'));
	   $ssologout = "https://sso.instun.gov.my/oxauth/restv1/end_session?id_token_hint=".$token."&post_logout_redirect_uri=https://myinstun.instun.gov.my/login";
